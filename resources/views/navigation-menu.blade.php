                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="sm:flex sm:items-center sm:ml-6">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('setup.jenis_kawasan.index') }}">
                                {{ __('Jenis Kawasan') }}
                            </x-jet-dropdown-link>
                    ...
                    <div class="sm:flex sm:items-center sm:ml-6">
                        <x-jet-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="flex items-center text-sm font-medium text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300">
                                    <div>{{ __('Pengurusan Pengguna') }}</div>
                            ...
                            <x-slot name="content">
                                <x-jet-dropdown-link href="{{ route('usermgmt.user.index') }}">
                                    {{ __('Pengguna') }}
                                </x-jet-dropdown-link>
                            </x-slot>
                ...
                <div class="relative ml-3">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('usermgmt.user.edit', Auth::user() ) }}">
                                {{ __('Profile') }}
                            </x-jet-dropdown-link>
