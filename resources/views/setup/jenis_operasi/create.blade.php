    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="w-11/12 mx-auto overflow-hidden sm:rounded-lg">
                ...
                <form action="{{ route('setup.jenis_operasis.store') }}" method="post">
                    @csrf
                    <div class="mt-4 -mb-3">
                            ...
                            <div class="relative p-8 overflow-auto rounded-xl">
                                <div
                                    ...
                                    <div class="col-span-2 p-4 rounded-lg shadow-lg bg-emerald-500">
                                        ...
                                        <x-jet-input id="kod_operasis" class="block w-full mt-1 uppercase" type="text"
                                            name="kod_operasis" :value="old('kod_operasis')" autofocus autocomplete="off" />
                                        <x-jet-input-error for="kod_operasis" class="mt-2" />
                                    </div>
                                    <div class="col-span-4 col-start-3 p-4 rounded-lg shadow-lg bg-emerald-500">
                                        ...
                                        <x-jet-input id="keterangan_operasis" class="block w-full mt-1" type="text" name="keterangan_operasis"
                                            :value="old('keterangan_operasis')" autofocus autocomplete="off" />
                                        <x-jet-input-error for="keterangan_operasis" class="mt-2" />
                                    </div>
                                </div>
                            </div>
                            <div
