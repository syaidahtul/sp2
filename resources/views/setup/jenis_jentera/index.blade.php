                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    ...
                    <form wire:submit.prevent="submit">
                        ...
                        <div class="flex items-center justify-start px-4 py-3 text-right shadow bg-gray-50 sm:px-6 sm:rounded-tl-md sm:rounded-tr-md">
                            <div class="px-4 sm:px-0">
                                <h3 class="text-lg font-medium text-gray-900 uppercase">
                                    {{ __('Kriteria Carian Jenis Jentera') }}</h3>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-4 px-4 py-3 text-right shadow bg-gray-50 sm:px-6 sm:rounded-bl-md sm:rounded-br-md">
                            <x-button.button-link-secondary type=bordered class="px-4 py-2" href="{{ route('setup.jenis_jentera.create' ) }}">
                                <x-icons.plus class="w-4 h-4" stroke="currentColor"></x-icons.plus> <span class="self-center mx-2">{{__('Jenis Jentera Baru') }} </span>
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <x-table class="mb-4 sm:rounded-sm">
                        ...
                        <x-slot name="body">
                            ...
                            @forelse ($jenis_jenteras as $item)
                                <x-table.row>
                                    <x-table.cell>
                                        {{ $item->kod }}
                                    </x-table.cell>
                                    ...
                                    <x-table.cell class="text-end">
                                        <x-button.button-link type="editIcon" href="{{ route('setup.jenis_jentera.edit', $item->kod ) }}">
