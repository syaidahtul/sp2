                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    ...
                    <form wire:submit.prevent="submit">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-4 md:col-span-1">
                                    ...
                                    <select name="status" id="status" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        @foreach (App\Models\JenisKawasans::STATUSES as $value => $label)
                        ...
                        <div class="flex items-center justify-end gap-4 px-4 py-3 text-right shadow bg-gray-50 sm:px-6 sm:rounded-bl-md sm:rounded-br-md">
                            <x-button.button-link-secondary type=bordered class="px-4 py-2" href="{{ route('setup.jenis_kawasan.create' ) }}">
                                <x-icons.plus class="w-4 h-4" stroke="currentColor"></x-icons.plus> <span class="self-center mx-2">{{__('Jenis Kawasan Baru') }} </span>
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <x-table class="mb-4 sm:rounded-sm">
                        ...
                        <x-slot name="body">
                            ...
                            @forelse ($jenis_kawasans as $item)
                                <x-table.row>
                                    <x-table.cell>
                                        {{ $item->kod }}
                                    </x-table.cell>
                                    ...
                                    <x-table.cell class="text-end">
                                        <x-button.button-link type="editIcon" href="{{ route('setup.jenis_kawasan.edit', $item->kod ) }}">
