                                    ...
                                    @forelse ($pbtKontraktor as $item)
                                        <x-table.row>
                                            ...
                                            <x-table.cell class="text-end">
                                                <x-button.button-link type="viewIcon" href="{{ route('setup.kontraktor.view', $item->pivot->kontraktor_id ) }}"><x-icons.eye class="w-4 h-4" stroke="green"></x-icons.eye> </x-button.button-link>
                                                <x-button.button-link type="editIcon" href="{{ route('setup.kontraktor.edit', $item->pivot->kontraktor_id ) }}"><x-icons.pencil class="w-4 h-4" stroke="blue"></x-icons.pencil> </x-button.button-link>
                                                @if ( strcmp($item->status_desc, 'Tidak aktif') !== 0 )
                                                    <x-button.button-link type="restoreIcon" href="{{ route('setup.kontraktor.createPbtKontraktor', $item->pivot->kontraktor_id ) }}" title="Tambah PBT berkenaan">
